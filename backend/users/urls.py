...
urlpatterns = [
    ...
    path('students/<int:pk>/update/', views.student_update_view, name='student-update'),
    path('students/<int:pk>/patch/', views.student_patch_view, name='student-patch'),
    path('students/<int:pk>/delete/', views.student_destroy_view, name='student-delete'),
