...
export default function StudentEdit(){
    ...
    const handleDeleteStudent = useCallback(async (e) => {
        try{
                ...
                <form onSubmit={handleSaveChanges}>
                    ...
                    <div className="form-group">
                        ...
                        <input 
                            ...
                            onChange={e => setStudent({...student, user: {...student.user, password: e.target.value}})}
                        />
                    </div>
                    <div className="form-group">
                        ...
                        <input 
                            ...
                            onChange={e => setStudent({...student, user: {...student.user, first_name: e.target.value}})}
                        /> 
                    </div>
                    <div className="form-group">
                        ...
                        <input 
                            ...
                            onChange={e => setStudent({...student, user: {...student.user, last_name: e.target.value}})}
                        />                    </div>
                    <div className="form-group">
                        <label htmlFor="program">Program:</label>
                        <select id="program" name="program" value={student.program || ''} onChange={e => setStudent({...student, program: e.target.value})}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="year" name="year" required value={student.year || ''} onChange={e => setStudent({...student, year: e.target.value})}/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="group">Group:</label>
                        <input type="text" id="group" name="group" required value={student.group || ''} onChange={e => setStudent({...student, group: e.target.value})}/>
                    </div>
